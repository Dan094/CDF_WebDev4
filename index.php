  ...
  <body style="overflow-x: hidden;">
        ...
        <div class="sec heroimg" id="section1" style="height:100vh;">
                <div class="container" > 
                        ...
                        <div class=" heroimg" >
                                <div class="row">
                                        <div class="col xl5 l5 m8 s10"  style="margin-top:15rem;">
                                                <h1 class="bigtxt" data-aos="fade-up">Your adventure of a lifetime awaits!</h1>
                                        </div>
                                        <div class="col l10 m5">
                                                <a class="waves-effect waves-light btn-large" style="background-color: #F3A530;font-weight:bold;">Donate</a>
                                        </div>
                                        <div class="col l10 row scrollsection" style="width:100%; position: relative;">
        ...
        <div class="sec"  style="height:120vh; margin-top:8rem; background-color: #A8B66E; border:none;" id="section4" >
                        ...
                        <ul class="collapsible expandable" style="width:50vw; margin:0 auto; border:none;">
                                        <li class="active" data-aos="fade-in" data-aos-duration="0">
                                        ...
                                        <li class="active" data-aos="fade-in" data-aos-duration="2000">
                                        ...
                                        <li class="active" data-aos="fade-in" data-aos-duration="2500">
                                        ...
                                        <li class="active" data-aos="fade-in" data-aos-duration="3000">
