...
>>>>>>> 9d4b24349099103770b64059402b0fb12157d8e1
                        ...
                        <div class=" heroimg" >
                                <div class="row">
                                        <div class="col xl5 l5 m8 s10"  style="margin-top:15rem; z-index:-20;">
                                                 <h1 class="bigtxt lax" data-lax-translate-y="0 0, 400 -400" data-lax-opacity="0 1, 100 0">Your adventure of a lifetime awaits!</h1>
                                        </div>
                                        <div class="col l10 m5">
                                                <a class="lax waves-effect waves-light btn-large" style="background-color: #F3A530;font-weight:bold;" data-aos="fade-in" data-lax-opacity="0 1, 100 0">Donate</a>
                                        </div>
                                        <div class="col l10 row scrollsection  lax" style="width:100%; position: relative;" data-lax-translate-y="0, 0, 400, -400" >
                ...
                <div class="col s12" >
                        <div class="row">
                                 ...
                                 <div class="sliderCont ">
                                        ...
                                        <div class="post " data-aos="fade-left" data-aos-delay="0">
        ...
        <div class="sec"  style="height:150vh; width:100vw; background-color: #A8B66E; border:none;" id="section4" >
                        <div class="col s12" style="padding: 5rem 0rem 2rem; ">
                                        <h2 class="secTitle" style="margin:5rem 0rem 0rem 0rem; padding:0rem; text-align: center; color:white;" id="section5">What we do</h2>
                                </div>
                        <ul class="collapsible expandable" style="width:50vw; margin:0 auto; border:none;">
                                        <li class="active" data-aos="fade-in" data-aos-delay="100">
                                                <div class="collapsible-header" style="background-color:#434831; border:none; color:white;"><i class="material-icons"><img src="images/badge1.svg" style="margin-left:-2rem;"></i>Lakes & Rivers</div>
                                                <div class="collapsible-body"><span>With over two million lakes and rivers and 20 per cent of the world’s freshwater, Canada has an incredible abundance of aquatic natural resources. Canadians share a deep historical connection to freshwater; we rely on it for transportation, for resources, for employment, for food and for recreation — swimming, boating, fishing or simply admiring the scenery of a natural lake or wild river.</span></div>
                                        </li>
                                        ...
                                        <li class="active" data-aos="fade-in" ddata-aos-delay="400">
                                                <div class="collapsible-header" style="background-color:#434831; border:none; color:white;"><i class="material-icons"><img src="images/badge4.svg" style="margin-left:-2rem;"></i>Coasts & Oceans</div>
                                                <div class="collapsible-body"><span>Canada is the second largest country in the world; the land area of our country is almost 10 million Km2. What is often forgotten is that our country also includes more than seven million Km2 of ocean and more than 200,000 Km of coastline!

                                                                We utilize the ocean for many purposes</span></div>
                                        </li>
                                        <li class="active" data-aos="fade-in" data-aos-delay="500">
                                                        <div class="collapsible-header" style="background-color:#434831; border:none; color:white;"><i class="material-icons"><img src="images/badge5.svg" style="margin-left:-2rem;"></i>Education</div>
                                                        <div class="collapsible-body"><span>CWF is dedicated to ensuring that our wildlife and natural spaces remain a treasured part of our country. The challenge is inspiring that same conservation ethic in new generations of Canadians to ensure they develop their own passion for wildlife conservation. At CWF, we develop education programs to help connect Canadians to nature. We encourage Canadians of all ages to participate in individual conservation actions and to experience, enjoy and value nature. In an ever-increasing urban society, the greatest challenge is developing those connections to our natural world. Education and experiential learning are key pillars in programming designed to meet this challenge.</span></div>
                                                </li>
                                        <li class="active" data-aos="fade-in" data-aos-duration="600">
                                                <div class="collapsible-header" style="background-color:#434831; border:none; color:white;"><i class="material-icons"><img src="images/badge6.svg" style="margin-left:-2rem;"></i>Connect with Nature</div>
                                                <div class="collapsible-body"><span>Canadians are spending most of their lives indoors – reports indicate as much as 90 per cent of our time is spent inside. Both doctors and scientists confirm that a lack of exposure to nature actually contributes to human illness. Our disconnection from nearby nature is a prime reason for the declining state of human health, both mental and physical.</span></div>
                                        </li>
